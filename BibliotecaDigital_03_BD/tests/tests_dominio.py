...
class TestLibro(unittest.TestCase):
    ...
    def test_crear_libro(self):
        libro1 = Libro(1, "El principito", "Antoine de Saint-Exupéry", 9.5)
        ...
        libro2 = Libro(2, "1984", "George Orwell", 10)
    ...
    def test_crear_libro_id_no_numerico_lanza_excepcion(self):
        with self.assertRaises(ValueError):
            Libro("a", "El principito", "Antoine de Saint-Exupéry", 9.5)

    def test_crear_libro_nombre_vacio_lanza_excepcion(self):
        with self.assertRaises(ValueError):
            Libro(1, "", "Antoine de Saint-Exupéry", 9.5)

    def test_crear_libro_autor_vacio_lanza_excepcion(self):
        with self.assertRaises(ValueError):
            Libro(1, "El principito", "", 9.5)
    ...
    def test_crear_libro_calificacion_erronea_lanza_execpcion(self):
        ...
        with self.assertRaises(ValueError):
            Libro(1, "El principito", "Antoine de Saint-Exupéry", 11)

        with self.assertRaises(ValueError):
            Libro(1, "El principito", "Antoine de Saint-Exupéry", 'a')
        ...
        with self.assertRaises(ValueError):
            Libro(1, "El principito", "Antoine de Saint-Exupéry", '')
