class Libro:
    def __init__(self, p_id, p_nombre, p_autor, p_calificacion, p_id_usuario):
        ...
        # self.__usuarios_seguidores = []

    # @property
    # def usuarios_seguidores(self):
    #     return self.__usuarios_seguidores       
    ...
    # def agregar_id_usuario_seguidor(self, id_usuario):
    #     if not isinstance(id_usuario, int):
    #         raise ValueError("El id del usuario debe ser un número entero")
    #     if id_usuario not in self.__usuarios_seguidores:
    #         self.__usuarios_seguidores.append(id_usuario)
    #     else:
    #         raise ValueError("El usuario ya sigue este libro")
...
class Usuario:
    def __init__(self, p_id, p_nombre, p_email, p_password):
        ...
        # self.__libros_seguidos = []

    # @property
    # def libros_seguidos(self):
    #     return self.__libros_seguidos
    ...
    # def agregar_libro_seguido(self, id_libro):
    #     if not isinstance(id_libro, int):
    #         raise ValueError("El id del libro debe ser un número entero")
    #     if id_libro not in self.__libros_seguidos:
    #         self.__libros_seguidos.append(id_libro)
    #     else:
    #         raise ValueError("El libro ya está siendo seguido por el usuario")
